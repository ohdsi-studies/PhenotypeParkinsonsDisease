...
#
# This file is part of PhenotypeParkinsonsDisease
#
...
styler::style_pkg()
OhdsiRTools::checkUsagePackage("PhenotypeParkinsonsDisease")
...
OhdsiRTools::createRenvLockFile(rootPackage = "PhenotypeParkinsonsDisease",
                                mode = "description",
